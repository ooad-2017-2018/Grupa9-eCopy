...
namespace ECopy.Models
{
    public class Library
    {
        ...
        public UIElement Marker()
        {
            ...
            outer.Margin = new Windows.UI.Xaml.Thickness(-12.5, -12.5, 0, 0);
            Ellipse inner = new Ellipse() { Width = 50, Height = 50 };
            inner.Margin = new Windows.UI.Xaml.Thickness(-10, -10, 0, 0);
            Ellipse core = new Ellipse() { Width = 10, Height = 10 };
            core.Fill = new SolidColorBrush(Colors.Pink);
        ...
        public UIElement MarkerText(string Text)
        {
            ...
            text.Foreground = new SolidColorBrush(Colors.Pink);
